...
public class AssetManager : MonoBehaviour
{
    ...
    {
        weapons.Add(new TestWeapon("Weapon 1", "Does things", 0, 0, 1.5f, 5, 5, 2, 2, 1, new Vector3(0, 3, 4), new Vector3(4, 1, 2), weaponImages[0], chosenWeaponImages[0], weaponModels[0]));
